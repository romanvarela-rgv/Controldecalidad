...
{
    public float moveSpeed = 4f; // Velocidad m�xima
    public float acceleration = 15f; // Aceleraci�n del movimiento
    public float deceleration = 10f; // Desaceleraci�n al frenar
    public float hInput;
    public float vInput;
    ...
    private IEnumerator SlowDownPlayer()
    {
        ...
        yield return new WaitForSeconds(2f); // Duraci�n de la ralentizaci�n
